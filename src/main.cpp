...
int main() {
    ...
    /***********************************************
     * Constants and variables definitions Begin ---->
     ************************************************/
#define MAX_VEL          49.4
#define MAX_PTS          30
#define MAX_SPLINE_PTS   3
...
#define MPH_TO_MPS       0.447
    ...
    /***********************************************
     * Constants and variables definitions End <-----
     ************************************************/
    ...
    h.onMessage([&map_waypoints_x,&map_waypoints_y,&map_waypoints_s,
            ...
            double target_y = curvegen(target_x);
            double target_distance = sqrt(target_x * target_x + target_y * target_y);

            double x_addon = 0;

            for (int i = 0; i < 50 - previous_path_x.size(); i++) {
                double N = (target_distance/ (TIME_STEP * ref_vel /2.24));
                double x_point = x_addon + target_x / N;
                double y_point = curvegen(x_point);
